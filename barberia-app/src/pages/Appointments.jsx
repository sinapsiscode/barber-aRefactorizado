...
const Appointments = () => {
  ...
  useEffect(() => {
    // Siempre cargar las citas mock para asegurar que tenemos las de prueba
    console.log('🔄 CARGANDO CITAS MOCK...');
    loadMockAppointments(true);
    console.log('✅ CITAS MOCK CARGADAS');
  }, []);
